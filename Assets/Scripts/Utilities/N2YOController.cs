...
namespace SatLight.Utilities
{
    ...
    {
        [SerializeField] private string API_KEY = "DGZAPN-JW8G79-QK5N5H-58IU";
        private readonly string baseUrl = "https://api.n2yo.com/rest/v1/satellite/";
        ...
        {
            var response = await MakeGetWebRequest(baseUrl + $"tle/{id}");
        ...
        public async Task<PositionResponse> GetSatellitePositions(
            ...
            int seconds)
        {
            var response = await MakeGetWebRequest(baseUrl +
