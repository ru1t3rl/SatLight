...
namespace StyleSmith.Editor.PropertyDrawers
{
    ...
    public class TypographyPropertyDrawer : PropertyDrawer
    {
        ...
        private static Dictionary<string, bool> _expandedStates = new ();
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            _expandedStates[propertyKey] =
                EditorGUI.Foldout(foldoutRect, _expandedStates[propertyKey], nameProperty.stringValue);
        ...
        private void RenderProperty(Rect position, SerializedProperty property, string label,
